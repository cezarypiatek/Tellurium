...
using MaintainableSelenium.Web.Services.TestResult.Queries;

namespace MaintainableSelenium.Web.Services.TestResult
{
    public class TestResultService : ITestResultService
    {
        private readonly IRepository<Toolbox.Screenshots.Domain.TestResult> testRepository;
        private readonly IRepository<TestSession> testSessionRepository;
        private readonly IRepository<Project> projectRepository;
        private readonly ISessionContext sessionContext;

        public TestResultService(IRepository<Toolbox.Screenshots.Domain.TestResult> testRepository, 
        ...
        private static TestResultListItemDTO MapToTestResultListItemDTO(Toolbox.Screenshots.Domain.TestResult x)
        {
